...
use panda_common::{plan_err, Column, DataFusionError, Result, ScalarValue};
...
/// ```
/// # use panda_common::Column;
/// # use panda_expr::{lit, col, Expr};
/// let expr = col("c1");
...
/// ```
/// # use panda_expr::{lit, col, Operator, Expr};
...
mod test {
    ...
    use arrow::datatypes::DataType;
    use panda_common::Column;
    use panda_common::{Result, ScalarValue};
